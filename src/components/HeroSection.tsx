...
export default function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-28 pb-16 overflow-hidden bg-hero-gradient">
      {/* Glow Orbs */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
              <motion.div
                ...
                className="relative w-16 h-16 sm:w-20 sm:h-20 rounded-2xl p-0.5 bg-gradient-to-tr from-cyan-400 via-blue-500 to-purple-500 shadow-xl shadow-cyan-500/30 group hover:scale-105 transition-transform"
              >
              ...
              <motion.div
                ...
                transition={{ duration: 0.5 }}
                className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-slate-900/90 border border-cyan-500/40 text-cyan-300 text-xs sm:text-sm font-mono backdrop-blur-md shadow-lg shadow-cyan-500/10"
              >
                <span className="relative flex h-2.5 w-2.5">
                  <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-cyan-400 opacity-75"></span>
                  <span className="relative inline-flex rounded-full h-2.5 w-2.5 bg-cyan-500"></span>
                </span>
                <span>Sẵn sàng cho cơ hội mới & Đồ án tốt nghiệp</span>
            ...
            >
              ...
              <div className="h-10 text-xl sm:text-2xl font-mono text-cyan-300 flex items-center justify-center lg:justify-start gap-2">
                <Terminal className="w-6 h-6 text-purple-400 flex-shrink-0" />
                <span className="font-semibold">{currentText}</span>
                <span className="w-2.5 h-7 bg-cyan-400 animate-pulse ml-0.5" />
              </div>
            </motion.div>
            ...
            <motion.p
              ...
              className="text-base sm:text-xl text-slate-200 font-normal leading-relaxed max-w-2xl mx-auto lg:mx-0"
            >
              Full-Stack Developer | Cloud-Native & System Architecture Enthusiast.
              Chuyên thiết kế hạ tầng Serverless 0$ vận hành, xây dựng Microservices chịu tải cao và ứng dụng Data Mining nâng cao trải nghiệm người dùng.
            </motion.p>
            ...
            >
              ...
              <a
                href="#projects"
                className="w-full sm:w-auto relative group px-8 py-4 rounded-xl text-sm sm:text-base font-semibold text-space-bg overflow-hidden shadow-xl shadow-cyan-500/25 transition-all duration-300 hover:scale-105 active:scale-95"
              >
          ...
          >
            <div className="relative w-full max-w-md animate-float-slow">
              <div className="absolute -inset-1 rounded-3xl bg-gradient-to-r from-cyan-500 via-blue-600 to-purple-600 opacity-40 blur-xl group-hover:opacity-70 transition duration-1000 animate-pulse-glow" />

              <div className="relative rounded-2xl bg-slate-950/90 border border-slate-700/80 p-6 sm:p-7 backdrop-blur-2xl shadow-2xl space-y-5">
